/**
 * @file cordic.c
 * @brief CORDIC algorithm implementations.
 *
 * COordinate Rotation DIgital Computer -- an iterative algorithm for
 * evaluating trigonometric, hyperbolic, exponential, logarithmic, and
 * root functions using only shifts, additions, and a small look-up table.
 *
...
/**
 * @brief ANGLE_SHIFT shifts angle ALPHA to lie between BETA and BETA+2PI.
 *
 * @param alpha  the angle to be shifted.
 * @param beta  defines the lower endpoint of the angle range.
...
/**
 * @brief ARCCOS_CORDIC returns the arccosine of an angle using the CORDIC method.
 *
 * @param t  the cosine of an angle.  -1 <= T <= 1.
 * @param n  the number of iterations to take. A value of 10 is low.  Good accuracy is achieved with 20 or more iterations.
 * @return an angle whose cosine is T.
 */
...
/**
 * @brief ARCCOS_VALUES returns some values of the arc cosine function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
...
/**
 * @brief ARCSIN_CORDIC returns the arcsine of an angle using the CORDIC method.
 *
 * @param t  the sine of an angle.  -1 <= T <= 1.
 * @param n  the number of iterations to take. A value of 10 is low.  Good accuracy is achieved with 20 or more iterations.
 * @return an angle whose sine is T.
 */
...
/**
 * @brief ARCSIN_VALUES returns some values of the arc sine function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
 * @param[out] fx  the value of the function.
...
/**
 * @brief ARCTAN_CORDIC returns the arctangent of an angle using the CORDIC method.
 *
 * @param x  Y, define the tangent of an angle as Y/X.
 * @param n  the number of iterations to take. A value of 10 is low.  Good accuracy is achieved with 20 or more iterations.
...
/**
 * @brief ARCTAN_VALUES returns some values of the arc tangent function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
...
/**
 * @brief CBRT_CORDIC returns the cube root of a value using the CORDIC method.
 *
 * @param x  the number whose cube root is desired.
 * @param n  the number of iterations to take. This is essentially the number of binary digits of accuracy, and might go as high as 53.
...
/**
 * @brief CBRT_VALUES returns some values of the cube root function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function. Output double FX, the value of the function.
 */
...
/**
 * @brief COS_VALUES returns some values of the cosine function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
 * @param[out] fx  the value of the function.
...
/**
 * @brief COSSIN_CORDIC returns the sine and cosine of an angle by the CORDIC method.
 *
 * @param beta  the angle (in radians).
 * @param n  the number of iterations to take. A value of 10 is low.  Good accuracy is achieved with 20 or more iterations.
 * @param[out] c  *S, the cosine and sine of the angle.
 */
...
/**
 * @brief EXP_CORDIC evaluates the exponential function using the CORDIC method.
 *
...
/**
 * @brief EXP_VALUES returns some values of the exponential function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
 * @param[out] fx  the value of the function.
...
/**
 * @brief I4_HUGE returns a "huge" I4.
 *
 * @return a "huge" I4.
 */
int i4_huge(void) {
...
/**
 * @brief I4_MIN returns the minimum of two I4's.
 *
 * @param i1  I2, two integers to be compared.
...
/**
 * @brief LN_CORDIC evaluates the natural logarithm using the CORDIC method.
 *
 * @param x  the argument.
 * @param n  the number of steps to take.
...
/**
 * @brief LN_VALUES returns some values of the natural logarithm function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
 * @param[out] fx  the value of the function.
...
/**
 * @brief MULTIPLY_CORDIC computes Z=X*Y the CORDIC method.
 *
 * @param x  Y, the factors.
 * @return the product.
 */
...
/**
 * @brief R8_UNIFORM_01 returns a unit pseudorandom R8.
 *
 * @param[in,out] seed  the "seed" value.  Normally, this value should not be 0.  On output, SEED has been updated.
 * @return a new pseudorandom variate, strictly between 0 and 1.
 */
...
/**
 * @brief SIN_VALUES returns some values of the sine function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
 * @param[out] fx  the value of the function.
...
/**
 * @brief SQRT_CORDIC returns the square root of a value using the CORDIC method.
 *
...
/**
 * @brief SQRT_VALUES returns some values of the square root function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function. Output double FX, the value of the function.
 */
...
/**
 * @brief TAN_CORDIC returns the tangent of an angle using the CORDIC method.
 *
 * @param beta  the angle (in radians).
 * @param n  the number of iterations to take. A value of 10 is low.  Good accuracy is achieved with 20 or more iterations.
...
/**
 * @brief TAN_VALUES returns some values of the tangent function.
 *
 * @param[in,out] call  the routine increments N_DATA by 1, and returns the corresponding data; when there is no more data, the output value of N_DATA will be 0 again.
 * @param[out] x  the argument of the function.
 * @param[out] fx  the value of the function.
...
/**
 * @brief TIMESTAMP prints the current YMDHMS date as a time stamp.
 */
void timestamp() {
#define TIME_SIZE 40
